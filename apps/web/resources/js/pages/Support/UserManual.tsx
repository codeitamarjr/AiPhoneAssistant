            ...
            <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 px-4 py-10 sm:px-6 lg:px-8">
                <header className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-base text-muted-foreground">
                            Everything your team needs to set up, operate, and troubleshoot the AI Phone Assistant inside your
                            workspace. Link this page from your CRM or share it with new teammates during onboarding.
                        </p>
                    </div>
                ...
                <Section id="appointments" title="Appointments & viewings">
                    <div className="space-y-5">
                        <div>
                            <h3 className="text-lg font-semibold text-foreground">Create viewing slots</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-foreground">Upcoming and past slots</h3>
                            <ul className="mt-2 list-disc space-y-2 pl-5">
                ...
                <Section id="listings" title="Listing management">
                    <div className="space-y-5">
                        <div>
                            <h3 className="text-lg font-semibold text-foreground">Creating or editing a listing</h3>
                            <ul className="mt-2 list-disc space-y-2 pl-5">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-foreground">Publishing & lifecycle</h3>
                            <ul className="mt-2 list-disc space-y-2 pl-5">
                ...
                <Section id="settings" title="Settings & configuration">
                    <div className="space-y-6">
                        {settingsSections.map((section) => (
                            <div key={section.title} className="rounded-lg border border-border/60 p-4">
                ...
                <Section id="notifications" title="Email notifications & CRM sync">
                    <ul className="list-disc space-y-2 pl-5">
                ...
                <Section id="workflow" title="Daily workflow checklist">
                    <ul className="list-disc space-y-2 pl-5">
                    ...
                    <dl className="space-y-4">
                        {troubleshootingItems.map((item) => (
                            <div key={item.prompt} className="rounded-lg border border-border/60 p-4">
                                <dt className="text-base font-semibold text-foreground">{item.prompt}</dt>
                                <dd className="mt-2 text-sm text-muted-foreground">{item.resolution}</dd>
                            </div>
                        ))}
                    </dl>
                </Section>

                <Section id="support" title="Support & additional resources">
                    <ul className="list-disc space-y-2 pl-5">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-semibold text-foreground">Call status reference</h3>
                            <div className="mt-3 overflow-x-auto">
                                <table className="w-full min-w-[360px] text-left text-sm">
                                    ...
                                    <tbody>
                                        {callStatuses.map((row) => (
                                            <tr key={row.status} className="border-t border-border/60">
                                                <td className="px-4 py-2 font-mono text-sm text-foreground">{row.status}</td>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-foreground">Lead status reference</h3>
                            <div className="mt-3 overflow-x-auto">
                                <table className="w-full min-w-[360px] text-left text-sm">
                                    <thead>
                                        <tr className="bg-muted text-xs uppercase text-muted-foreground">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-foreground">Appointment modes</h3>
                            <div className="mt-3 overflow-x-auto">
                                <table className="w-full min-w-[360px] text-left text-sm">
                                    <thead>
                                        <tr className="bg-muted text-xs uppercase text-muted-foreground">
                                    ...
                                    <tbody>
                                        {appointmentModes.map((row) => (
                                            <tr key={row.mode} className="border-t border-border/60">
                                                <td className="px-4 py-2 text-sm text-foreground">{row.mode}</td>
                                                <td className="px-4 py-2 text-sm text-muted-foreground">{row.description}</td>
                                            </tr>
                                        ))}
                                    </tbody>
